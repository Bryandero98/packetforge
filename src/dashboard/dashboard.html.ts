...
const I18N = {
  en: {
    ...
    needsApiKey: 'Semantic search needs GEMINI_API_KEY configured on the server.',
  ...
  es: {
    ...
    needsApiKey: 'La búsqueda semántica necesita GEMINI_API_KEY configurada en el servidor.',
